      ...
      <div class="container">
          ...
          <div class="row">
              ...
              <div class="col-xl-6 wow fadeInLeft mb-4 mb-xl-0">
                <h2 class="el__date mb-0">2023/10/11 <span>(月) 開院</span></h2>
                <div class="el__excerpt">
                	<p>東京駅エリアに新規開院するビスカ歯科クリニックです。<br>
              ...
              <div class="col-xl-6 wow fadeInRight">
                  ...
                  <ul class="ul-list row g-4 justify-content-center">
                  	<li class="col-sm-4">
                  		<div class="-li-item">
                    		<p class="-li-item--date">10/6<small>(Fri)</small></p>
                    		<p class="-li-item--time">10:00-17:00</p>
                  		</div>
                  	</li>
                  	<li class="col-sm-4">
                  		<div class="-li-item">
                    		<p class="-li-item--date">10/7<small>(Sat)</small></p>
                    		<p class="-li-item--time">11:00-18:00</p>
                    	</div>
                  	</li>
                  	<li class="col-sm-4">
                  		<div class="-li-item">
                    		<p class="-li-item--date">10/8<small>(Sun)</small></p>
                    		<p class="-li-item--time">11:00-18:00</p>
                    	</div>
                  	</li>
                  </ul>
      	...
      	<div class="el-boxnew wow fadeInUp">
      		<div class="row">
      			<div class="col-lg-4 flex-center">
	          		...
	          		<div class="c-header__sub">お知らせ</div>
	          	</header>
      			</div>
      			<div class="col-lg-8">
      		...
      		<div class="row g-4 g-md-5 g-xl-80 g-xxl-120">
      			<div class="col-lg-6 -col-left">
      				<div>
      					...
      					<p><a href="tel:<?= $init['clinic']['tel_num'] ?>" class="el-box__tel is-tel"><i class="icon-phone me-2"></i><?= $init['clinic']['tel_num'] ?></a></p>
      				...
      				<div>
      					...
      					<div class="d-none d-sm-flex justify-content-center mb-3">
      						...
      						<div class="el-box__meta text-start">
      							<p>24時間受付可能なWEB予約をご利用ください。</p>
      							<p>スマートフォンご利用の方は<br>QRコードの読み込みからもご予約できます。</p>
      						</div>
      					</div>
      					<div class="d-flex justify-content-center gap-3 flex-wrap">
      						<a href="" class="btn btn-primary -large is-web"><span>初診の方はこちら</span></a>
      						<a href="" class="btn btn-primary -large is-web"><span>再診の方はこちら</span></a>
      					</div>
      				</div>
      			</div>
      		</div>
        		...
        		<div class="col-lg-6 col-left">
        			...
        			<div class="col-left__wrap">
        				<div class="wow fadeInUp">
	          			<h3 class="mb-4 mb-md-5 text-center text-lg-start">地域全体を健やかに、活発に</h3>
		            		...
		            		<p>情に棹させば流される。智に働けば角が立つ。どこへ越しても住みにくいと悟った時、詩が生れて、画が出来る。とかくに人の世は住みにくい。意地を通せば窮屈だ。 とかくに人の世は住みにくい。<br>
								...
								<div class="text-center wow fadeInUp">
									<a href="/<?= $dir ?>staff/" class="btn btn-primary-mask ef__shine">詳しくはこちら</a>
								</div>
							</div>
        		</div>
    ...
    <div class="sc-group-service-clinic">
        <section class="sc-service">
          <div class="container">
          	...
          	<div class="c-content">
            	<ul class="row g-2 g-md-3 g-xl-4 mb-5 pb-3 justify-content-center">
            		<li class="col-4 col-sm-4 col-lg-20 wow fadeInUp" data-wow-delay=".1s">
            			<div class="el-item">
            			  	<div class="el-item__thumb">
            		...
            		<li class="col-4 col-sm-4 col-lg-20 wow fadeInUp" data-wow-delay=".2s">
            			<div class="el-item">
            			  	<div class="el-item__thumb">
	            			    <div class="dnfix__thumb -contain">
            		...
            		<li class="col-4 col-sm-4 col-lg-20 wow fadeInUp" data-wow-delay=".3s">
            			<div class="el-item">
            			  	<div class="el-item__thumb">
	            			    <div class="dnfix__thumb -contain">
            			    ...
            			    <h3 class="el-item__title"><a href="services/" class="stretched-link">根管治療</a></h3>
            			</div>
            		</li>
            		<li class="col-4 col-sm-4 col-lg-20 wow fadeInUp" data-wow-delay=".4s">
            			<div class="el-item">
            			  	<div class="el-item__thumb">
	            			    <div class="dnfix__thumb -contain">
            		...
            		<li class="col-4 col-sm-4 col-lg-20 wow fadeInUp" data-wow-delay=".5s">
            			<div class="el-item">
            			  	<div class="el-item__thumb">
	            			    <div class="dnfix__thumb -contain">
            		...
            		<li class="col-4 col-sm-4 col-lg-20 wow fadeInUp" data-wow-delay=".6s">
            			<div class="el-item">
            			  	<div class="el-item__thumb">
	            			    <div class="dnfix__thumb -contain">
            		...
            		<li class="col-4 col-sm-4 col-lg-20 wow fadeInUp" data-wow-delay=".7s">
            			<div class="el-item">
            			  	<div class="el-item__thumb">
	            			    <div class="dnfix__thumb -contain">
            		...
            		<li class="col-4 col-sm-4 col-lg-20 wow fadeInUp" data-wow-delay=".8s">
            			<div class="el-item">
            			  	<div class="el-item__thumb">
	            			    <div class="dnfix__thumb -contain">
            		...
            		<li class="col-4 col-sm-4 col-lg-20 wow fadeInUp" data-wow-delay=".9s">
            			<div class="el-item">
            			  	<div class="el-item__thumb">
	            			    <div class="dnfix__thumb -contain">
	          		...
	          		<div class="col-md-6 col-left">
	          			<div class="col-left__wrap wow fadeInLeft">
				          	...
				          	<div class="d-none d-md-block">
					          	<p class="mb-3"><a href="facilities/" class="btn btn-primary-mask ef__shine -s2">院内紹介</a></p>
					          	<p><a href="equipments/" class="btn btn-primary-mask ef__shine -s2">設備紹介</a></p>
				          	</div>
	        	...
	        	<div class="row">
	        		...
	        		<div class="col-md-4 el-col">
	        			<div class="el-box__item">
	        				...
	        				<div class="el-box__excerpt">待ち時間軽減のため、原則予約制で診療しています。ご予約はお電話(<a href="tel:<?= $init['clinic']['tel_num'] ?>"><?= $init['clinic']['tel_num'] ?></a>)か<a href="<?= $init['clinic']['web'] ?>">WEB予約</a>にてご連絡ください。</div>
	        			</div>
	        		</div>
	        		<div class="col-md-4 el-col">
	        			<div class="el-box__item">
	        				<h3 class="el-box__title">急患随時受付</h3>
	        				<div class="el-box__excerpt">柔軟に対応しております。混雑している場合はお待たせすることもございますので、ご来院いただく前に一度お電話(<a href="tel:<?= $init['clinic']['tel_num'] ?>"><?= $init['clinic']['tel_num'] ?></a>)にてお問い合わせください。</div>
	        			</div>
	        		</div>
	        	</div>
	        </div>
