			...
			<section class="access-map">
			  <div class="container">
			    ...
			    <div class="el-box -s2">
			    	...
			    	<div class="row gx-4 gy-5 g-md-5 g-xl-100 justify-content-center">
			    		<div class="col-sm-6 col-md-4 col-lg-4 wow fadeInUp">
			    			<div class="el-item">
			    			  <div class="el-item__thumb">
			    			    <div class="dnfix__thumb -contain">
			    			      <img src="../assets/images/access/access-img-bus.png" alt="">
			    			    </div>
			    			  </div>
			    			  <div class="el-item__meta">
			    			    <h3 class="el-item__title">電車でお越しの方</h3>
			    		...
			    		<div class="col-sm-6 col-md-4 col-lg-4 wow fadeInUp">
			    			<div class="el-item">
			    			  <div class="el-item__thumb">
			    			    <div class="dnfix__thumb -contain">
			    			      <img src="../assets/images/access/access-img-car.png" alt="">
			    			    </div>
			    			  </div>
			    			  <div class="el-item__meta">
			    			    <h3 class="el-item__title">車でお越しの方</h3>
			    			    <div class="el-item__excerpt text__truncate -n3">テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</div>
			    			  </div>
			    			</div>
			    		</div>
			    		<div class="col-sm-6 col-md-4 col-lg-4 wow fadeInUp">
			    			<div class="el-item">
			    			  <div class="el-item__thumb">
			    			    <div class="dnfix__thumb -contain">
			    			      <img src="../assets/images/access/access-img-train.png" alt="">
			    			    </div>
			    			  </div>
			    			  <div class="el-item__meta">
			    			    <h3 class="el-item__title">バスでお越しの方</h3>
			    			    <div class="el-item__excerpt text__truncate -n3">テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</div>
			    			  </div>
			    			</div>
			    		</div>
		    	...
		    	<div class="row gx-4 gy-5 g-md-5 g-xl-80 mb-5 justify-content-center wow fadeInUp">
		    		...
		    		<div class="col-md-6 col-lg-4 el-col">
		    			<div class="el-item">
		    			  ...
		    			  <div class="el-item__thumb">
		    			  	<div class="el-item__number">4</div>
		    			    <div class="dnfix__thumb">
		    			      <img src="../assets/images/access/thumb.jpg" alt="">
		    			    </div>
		    			  </div>
		    		...
		    		<div class="col-md-6 col-lg-4 el-col">
		    			<div class="el-item">
		    			  ...
		    			  <div class="el-item__thumb">
		    			  	<div class="el-item__number">5</div>
		    			    <div class="dnfix__thumb">
		    			      <img src="../assets/images/access/thumb.jpg" alt="">
		    			    </div>
		    			  </div>
		    		...
		    		<div class="col-md-6 col-lg-4 el-col">
		    			<div class="el-item">
		    			  ...
		    			  <div class="el-item__thumb">
		    			  	<div class="el-item__number">6</div>
		    			    <div class="dnfix__thumb">
		    			      <img src="../assets/images/access/thumb.jpg" alt="">
		    			    </div>
		    			  </div>
	        	...
	        	<div class="row">
	        		...
	        		<div class="col-md-4 el-col">
	        			<div class="el-box__item">
	        				...
	        				<div class="el-box__excerpt">待ち時間軽減のため、原則予約制で診療しています。ご予約はお電話(<a href="tel:<?= $init['clinic']['tel_num'] ?>"><?= $init['clinic']['tel_num'] ?></a>)にてご連絡ください。</div>
	        			</div>
	        		</div>
	        		<div class="col-md-4 el-col">
	        			<div class="el-box__item">
