<footer class="footer">
		...
		<div class="row mb-5 pb-2">
			<div class="col-lg-6 wow fadeInLeft mb-4 mb-lg-0">
				<div class="footer__item text-center text-lg-start">
					...
					<div class="ps-md-5">
                        <p class="footer__address mb-4">〒<?= $init['clinic']['postal'].'<br>'.$init['clinic']['address'].$init['clinic']['address_2'] ?></p>
						...
						<div class="d-flex flex-wrap justify-content-center justify-content-lg-start gap-3">
							...
							<button class="btn btn-primary -large is-web"><span>WEB予約はこちら</span></button>
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-6 wow fadeInRight">
				<div class="footer__item">
                    <div class="schedule">
    					<?php include(ROOTPATH."assets/inc/working-time.php"); ?>
                    </div>
				</div>
			</div>
		</div>
	...
	<ul class="d-none d-xl-flex ul-list mb-5 wow fadeInUp">
...
<div class="fixed-contact style2 fixed">
    <a href="<?= $init['clinic']['web'] ?>" class="fixed-contact__item mb-md-1 is-web" target="_blank">
        <i class="icon-calendar"></i>WEB<br>診療予約
    </a>

    <div class="fixed-contact__item -s2 is-web js-fixed-item-toggle mb-md-1" href="/<?= $dir ?>#home-top" target="_blank">
    ...
    <div class="fixed-contact__item -s3 is-line" href="<?= $init['clinic']['line'] ?>">
